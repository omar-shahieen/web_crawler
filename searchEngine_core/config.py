...
RETRY_BASE_DELAY: float = 1.5   # seconds; increases by 1.0 per retry
...
# How many consecutive robots.txt denials before a host is abandoned entirely.
ROBOTS_MAX_CONSECUTIVE_BLOCKS: int = 5

# How many consecutive empty/failed fetches before a host is abandoned entirely.

...
function writeRecentSearches(values) {
  try {
    localStorage.setItem(RECENT_KEY, JSON.stringify(values.slice(0, MAX_RECENT)))
  } catch {
    ...
    <div className={styles.wrapper} ref={wrapperRef}>
      ...
      {!compact && (
        <div className={styles.actionRow}>
          <button className={styles.subtleButton} type="button" onClick={handleLuckySearch} disabled={!query.trim() || luckyLoading}>
